...
const schema = z.object({
	...
	icon: z.string({ required_error: t("inputsErrors.required") }),
	link: z.string({ required_error: t("inputsErrors.required") }),
	isVisible: z.boolean(),
});
...
<template>
	...
	>
		...
		>
			<UFormField
				class="w-full"
				:label="$t('inputs.linkName')"
				name="curPrice"
			>
				<UInput
					class="w-full"
					size="md"
					:placeholder="$t('inputs.linkName')"
					v-model="state.name"
				/>
			</UFormField>
			...
			<UFormField
				class="w-full"
				:label="$t('inputs.visibility')"
				name="curPrice"
			>
				<USwitch
					class="w-full"
					size="md"
					:placeholder="$t('inputs.visibility')"
