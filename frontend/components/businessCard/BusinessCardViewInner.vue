...
import type { IBusinessCardDetail } from "@/types/businessCard.ts";
import { getImage } from "@/assets/utils/images.ts";
...
<template>
	<div
		class="overflow-auto lg:w-[576px] w-full lg:h-[570px] :lg-translate-x-3 rounded-r-lg bg-gray-900"
	>
		<div
